...
<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky" style="margin-top: 4rem;">
        <div class="list-group list-group-flush mx-3 mt-4">
            <a href="/biblioteca/" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                <i class="fas fa-tachometer-alt fa-fw me-3"></i><span>Tablero principal</span>
            </a>
            <a href="/biblioteca/php/view/books/index.php" class="list-group-item list-group-item-action py-2 ripple">
                <i class="fas fa-book fa-fw me-3"></i><span>Libros</span>
            </a>
