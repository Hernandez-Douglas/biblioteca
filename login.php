                ...
                <form method="POST" action="#login">
                    <div class="mb-8">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input id="username" name="username" class="block pr-10 shadow appearance-none border-2 border-orange-100 rounded w-full py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-orange-500 transition duration-500 ease-in-out" placeholder="bibliotecario@universidad.com" />
                        </div>
                        <strong class="text-red-500 text-xs italic">nombre de usuario es requerido</strong>
                    </div>
